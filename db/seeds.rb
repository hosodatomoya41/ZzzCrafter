...
routines = [
  { name: '瞑想', description: '腹式呼吸を意識して瞑想をしましょう。<br>寝ながらでも問題ありません。<br>最初は5分間を目標に、徐々に時間を伸ばしていってみましょう。',
  ...
  '寝る前のストレッチをしましょう。<br>1分間、体を伸ばすだけで心身の緊張がほぐれ、寝付きがよくなる効果が期待できます。' },
  { name: 'アロマ',
    description: 'ラベンダー、スイートオレンジ、カモミール等はリラックス系のアロマで、安眠へ導く効果が期待できると言われています。<br>お気に入りの香りのアロマを探してみるのはいかがでしょうか。', line_text: "そのまま送信してください。\n[アロマを焚く]を追加しました", recommend_time: :before0 },
  { name: '音楽鑑賞', line_text: "そのまま送信してください。\n[音楽鑑賞]を追加しました。", recommend_time: :before0, description:
  'リラックス効果があるクラシックや自然音が入った音楽を聞くのがおすすめです。<br>激しい音楽や、歌詞がある音楽は意識が音楽に向いてしまうので非推奨です。' },
  { name: '日記', description: '不満や明日やること等、考えを何でもいいのでノートに書き出しましょう。<br>続けることでネガティブ感情やストレスが整理されてリラックスでき、アウトプットにもなります。',
    line_text: "そのまま送信してください。\n[日記を書く]を追加しました。", recommend_time: :before1 },
  { name: '入浴',
    description: '１時間前から入浴(シャワーを浴びる)することにより、寝るタイミングで体温が下がり始めて眠りにつきやすくなります。<br>湯船の温度は39度〜40度あたりのぬるま湯で、20〜30分ほど浸かるのがオススメです！', line_text: "そのまま送信してください。\n[入浴]を追加しました", recommend_time: :before1_5 },
  { name: '読書', description: '買ったのはいいけどなかなか読む機会がなかった本、この機会に読んでみるのもいいかもしれません！<br>紙の本ならデジタル・デトックスの効果もあります。',
  ...
  { name: 'デジタル・デトックス',
    description: '夜間にスマホやパソコンのブルーライトを浴びると、睡眠ホルモンと言われているメラトニンの分泌が抑制され、寝付きの悪さに繋がります。<br>別のルーティーンと組み合わせたりして、寝る前にはブルーライトを浴びないようにしましょう。<br>スマホやパソコンを物理的に遠くへ置いておくのもおすすめです。', line_text: "そのまま送信してください。\n[デジタル・デトックス]を追加しました", recommend_time: :before1 },
  { name: '運動',
    description: '運動習慣がある人には不眠が少ないと言われています。<br>ジョギングやウォーキング、筋トレなど適度な運動を行うことにより、睡眠ホルモンのメラトニンの材料となるセロトニンの分泌が増えます。<br>その結果、寝る頃にはメラトニンがしっかり分泌されて安眠へと繋がります。', line_text: "そのまま送信してください。\n[運動]を追加しました", recommend_time: :before3 },
  { name: 'パワーナップ',
    description: '日中とんでもなく眠いとき、コーヒーを一杯なるべく早いペースで飲んでから10分ほど昼寝をしてみましょう。<br>そうすると、ちょうど目覚めたタイミングでカフェインの効果が効き始め、眠気が覚める効果があります。<br>その結果、変な時間帯に眠ってしまうリスクを減らすという期待ができます。', line_text: "そのまま送信してください。\n[パワーナップ]を追加しました", recommend_time: :before10 },
  { name: '夕飯', description: '食べ物の消化には2〜3時間かかると言われています。<br>夕飯は就寝の3時間以上前に済ませておくと胃腸への負担が軽減されて安眠へと繋がります。',
