...
routines = [
  ...
  "寝る前のストレッチをしましょう。\n1分間、体を伸ばすだけで心身の緊張がほぐれ、寝付きがよくなる効果が期待できます。" },
  { name: 'アロマ',
  ...
  { name: '入浴',
    description: "１時間前から入浴(シャワーを浴びる)することにより、寝るタイミングで体温が下がり始めて眠りにつきやすくなります。\n湯船の温度は39度〜40度あたりのぬるま湯で、20〜30分ほど浸かるのがオススメです！", line_text: "そのまま送信してください。\n[入浴]を追加しました", recommend_time: :before1_5 },
  { name: '読書', description: "買ったのはいいけどなかなか読む機会がなかった本、この機会に読んでみるのもいいかもしれません！\n紙の本ならデジタル・デトックスの効果もあります。",
  ...
  { name: 'デジタル・デトックス',
    description: "夜間にスマホやパソコンのブルーライトを浴びると、睡眠ホルモンと言われているメラトニンの分泌が抑制され、寝付きの悪さに繋がります。\n別のルーティーンと組み合わせたりして、寝る前にはブルーライトを浴びないようにしましょう。\nスマホやパソコンを物理的に遠くへ置いておくのもおすすめです。", line_text: "そのまま送信してください。\n[デジタル・デトックス]を追加しました", recommend_time: :before1 },
  { name: '運動',
    description: "運動習慣がある人には不眠が少ないと言われています。\nジョギングやウォーキング、筋トレなど適度な運動を行うことにより、睡眠ホルモンのメラトニンの材料となるセロトニンの分泌が増えます。\nその結果、寝る頃にはメラトニンがしっかり分泌されて安眠へと繋がります。", line_text: "そのまま送信してください。\n[運動]を追加しました", recommend_time: :before3 },
  { name: 'パワーナップ',
    description: "日中とんでもなく眠いとき、コーヒーを一杯なるべく早いペースで飲んでから10分ほど昼寝をしてみましょう。\nそうすると、ちょうど目覚めたタイミングでカフェインの効果が効き始め、眠気が覚める効果があります。\nその結果、変な時間帯に眠ってしまうリスクを減らすという期待ができます。", line_text: "そのまま送信してください。\n[パワーナップ]を追加しました", recommend_time: :before10 },
  ...
  "家事や整理整頓をすることで、心地よい環境を作り出し、それがリラックスと安心感につながります。\nまた、身体を軽く動かすことで、適度な疲れを感じやすくなります。" }
]
