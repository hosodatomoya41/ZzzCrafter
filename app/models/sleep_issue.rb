...
ISSUE_POINTS = {
  night_life: "昼夜逆転してしまい、朝起きれなくなってしまう経験がある人は多いのではないかと思います。<br>朝頑張って起きて、昼寝しないようにし、夜なるべく早めに寝ることを継続し、少しずつ改善していきましょう。<br>ルーティーンの一例として、日記で夜型生活を抜けるという決意を固め、アロマを焚きながら眠りにつくというのはいかがでしょうか。<br>もし昼間に眠気が限界になってしまったらパワーナップを行うのがおすすめです。",
