routines = [
  ...
  { name: "アロマ", description: "ラベンダー、スイートオレンジ、カモミール等はリラックス系のアロマで、安眠へ導く効果が期待できると言われています。<br>お気に入りの香りのアロマを探してみるのはいかがでしょうか。", line_text: "そのまま送信してください。\n[アロマを焚く]を追加しました", recommend_time: :before0 },
  ...
  { name: "日記", description: "不満や明日やること等、考えを何でもいいのでノートに書き出しましょう。<br>続けることでネガティブ感情やストレスが整理されてリラックスでき、アウトプットにもなります。", line_text: "そのまま送信してください。\n[日記を書く]を追加しました。", recommend_time: :before1 },
