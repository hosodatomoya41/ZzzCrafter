routines = [
  ...
  "リラックス効果のあるクラシックや、自然音が入った音楽を聴きましょう。激しい音楽や、歌詞がある音楽は意識が向いてしまうので非推奨です。"},
  { name: "日記", description: "不満や明日やること等、考えをノートに書き出しましょう。続けることでネガティブ感情やストレスが整理されてリラックスできます。", line_text: "そのまま送信してください。\n[日記を書く]を追加しました。", recommend_time: :before1 },
  { name: "入浴", description: "１時間前から入浴(シャワーを浴びる)することにより、寝るタイミングで体温が下がり始めて眠りにつきやすくなります。湯船の温度は39度〜40度あたりのぬるま湯で、20〜30分ほど浸かるのがオススメです！", line_text: "そのまま送信してください。\n[入浴]を追加しました", recommend_time: :before1_5 },
  ...
  { name: "デジタル・デトックス", description: "夜間にスマホやパソコンのブルーライトを浴びると、睡眠ホルモンと言われているメラトニンの分泌が抑制され、寝付きの悪さに繋がります。別のルーティーンと組み合わせたりして、寝る前にはブルーライトを浴びないようにしましょう。スマホやパソコンを物理的に遠くへ置いておくのもおすすめです。", line_text: "そのまま送信してください。\n[デジタル・デトックス]を追加しました", recommend_time: :before1 },
  ...
  { name: "パワーナップ", description: "日中とんでもなく眠いとき、コーヒーを一杯なるべく早いペースで飲んでから10分ほど昼寝をすると、ちょうど目覚めたタイミングでカフェインの効果が効き始め、眠気が覚める効果があります。その結果、変な時間帯に眠ってしまうリスクを減らすという期待ができます。", line_text: "そのまま送信してください。\n[パワーナップ]を追加しました", recommend_time: :before10 },
  { name: "夕飯", description: "食べ物の消化には2〜3時間かかると言われており、夕飯は就寝の3時間以上前に済ませておくと胃腸への負担が軽減されて安眠へと繋がります。", line_text: "そのまま送信してください。\n[夕飯を済ませる]を追加しました", recommend_time: :before3 },
